    ...
    <div class="owl-carousel">
        <div class="product-item">
            <div class="product-img">
                ...
                <div class="button-add flex">
                    ...
                    <button type="button" class="btnQuickView quick-view">
                    <span class="icon"><svg width="20px" height="20px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
            ...
            <div class="product-detail clearfix">
                <h3 class="pro-name text1line">
                    <a href="">Eglips Barbie Limited Edition</a>
                </h3>
        ...
        <div class="product-item">
            <div class="product-img">
                ...
                <a href="">
                    <picture>
                        <img src="https://product.hstatic.net/200000384051/product/f13041f4cc201bae5cb383b8f7b54a08_a3cb5ac532e04532b9a440acb9fa8ca0_grande.jpg" alt="">
                    </picture>
                </a>
                <div class="button-add flex">
                    <button type="button" class="btnQuickView quick-view">
